    ...
    <div class="container-fluid bg-dark mb-30">
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <h3 class="text-white fw-bold py-3"
                    style="font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">Welcome</h3>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{ route('user#home') }}" class="nav-item nav-link float-start me-2">
                                <i class="fa-solid fa-house-chimney"></i>
                            </a>
                            <a href="{{ route('user#contactPage') }}" class="nav-item nav-link float-start">
                                <button class="btn btn-sm btn-primary">Contact Us</button>
                            </a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <div class="dropdown d-inline me-5 ms-5">
                                ...
                                <ul class="dropdown-menu mt-2">
                                    <li><a class="dropdown-item py-2"
                                            href="{{ route('user#accountChangePage') }}">Account</a></li>
                                    <li><a class="dropdown-item py-2"
                                            href="{{ route('user#changePasswordPage') }}">Change
                                            Password</a></li>
                                    <li><span class="dropdown-item py-2 my-1">
                                            <form action="{{ route('logout') }}" method="post" class="d-block">
                                                @csrf
                                                <button class="btn btn-primary btn-sm px-3 rounded" type="submit">
